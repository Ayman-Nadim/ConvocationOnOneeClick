...
>(function ConvocationSheet({ data, bodyHtml, mission, sousTitre, pageNumber, totalPages }, ref) {
  return (
    ...
    >
      ...
      {/* Entête */}
      <header className="mb-6 leading-[1.5] text-right">
        <h1 className="text-[19px] font-bold mb-0.5">بوطيب سهام</h1>
        <p className="text-[13px]">خبيرة في الشؤون العقارية محلفة لدى المحاكم</p>
        <p className="text-[13px]">مهندسة مساحية طبوغرافية</p>
        <p className="text-[13px]">89 زنقة البنفسج، إقامة البنفسج، الطابق الأول</p>
      ...
      {/* Destinataire */}
      <div className="text-center font-bold text-[15px] leading-[1.6] mb-5">
        <p>
      ...
      {/* Références */}
      <div className="text-right font-bold text-[15px] mb-4 space-y-0.5">
        <p>
      ...
      {/* Corps */}
      <div
        className="convocation-body text-[15px] leading-[1.7] mb-6"
      ...
      <div className="relative mb-4 h-16">
        ...
        <div className="absolute left-0 top-0 text-center">
          <p className="font-bold underline underline-offset-4 mb-1">إمضاء :</p>
